  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-background-light dark:bg-background-dark">
      ...
      <main className="flex flex-1 flex-col overflow-hidden">
        <header className="shrink-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 pt-[max(0.75rem,env(safe-area-inset-top))] dark:border-slate-800 dark:bg-slate-900 md:px-8 md:py-4 md:pt-4">
